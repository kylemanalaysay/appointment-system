        ...
        <Col lg="3">
          ...
          <ListGroup className="footer__quick-links">
            <ListGroupItem className='ps-0 border-0 d-flex align-items-center gap-3'>
              ...
              <p className='mb-0'>L1 B1 Ortigas Ave Alfonso St. Rosario Pasig City</p>
            </ListGroupItem>
            <ListGroupItem className='ps-0 border-0 d-flex align-items-center gap-3'>
              <h6 className='mb-0 d-flex align-items-center gap-2'>
              ...
              <p className='mb-0'>https://www.facebook.com/PetraAndPepitaSalon</p>
            </ListGroupItem>
          </ListGroup>
        </Col>
      </Row>
